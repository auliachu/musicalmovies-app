  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $jenis_tiket; ?> -&gt; Disc : <?php echo $diskon; ?>%
        <input type="hidden" name="id_jenistiket" value="<?php echo $pecah['id_jenistiket']; ?>"> <input type="hidden" name="id_diskon" value="<?php echo $pecah['id_diskon']; ?>"></td>
      <td><?php echo $harga; ?> <input type="hidden" name="harga" value="<?php echo $pecah['harga_tiket']; ?>"></td>
       <td><?php echo $jumlah; ?> <input type="hidden" name="jumlah" value="<?php echo $jumlah; ?>"></td>
...
<h1>Data Customer</h1>
	   <table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		while($pecah=mysqli_fetch_array($kursi)) { 
			?>
 <?php //echo "<option value='$pecah[id_kursi]' $cek>".$pecah[no_kursi]."</option>"; 
		
		echo "<a href=updatekursi.php><input type=checkbox name=id_kursi[] value='$pecah[no_kursi]'><input type='button' value='$pecah[no_kursi]' name='simpankursi' class='btn btn-success'></a>";
