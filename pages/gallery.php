  ...
  <header id="header" class="hoc clear"> 
    ...
    <div class="three_quarter">
      <ul class="nospace clear">
        ...
        <li class="one_third">
          <div class="block clear"><a href="#"><i class="fas fa-envelope"></i></a> <span><strong>Our email:</strong> musicalaulia@gmail.com</span></div>
        </li>
        <li class="one_third">
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">Pages</a>
          <ul>
            ...
            <li><a href="font-icons.php">Font Icons</a></li>
          </ul>
        </li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">Musical Now On Showing</header>
          <ul class="nospace clear">
            <li class="one_quarter first"><a href="#"><img src="../images/demo/gallery/nct.jpg" alt=""></a></li>
